...
export const STORE_DETAILS: Record<string, StoreDetails> = {
    'Arlington, VA': { address: '1616 N Troy St, Arlington, VA 22201', lat: 38.89801, lon: -77.08295 },
    'Boise, ID': { address: '150 N 8th St #200, Boise, ID 83702', lat: 43.6166, lon: -116.2023 },
    'Charlotte, NC': { address: '1820 South Blvd, Charlotte, NC 28203', lat: 35.2078, lon: -80.8533 },
    'Chattanooga, TN': { address: '1110 Market St, Chattanooga, TN 37402', lat: 35.0456, lon: -85.3097 },
    'Columbia, SC': { address: '1332 Main St, Columbia, SC 29201', lat: 34.0064, lon: -81.0354 },
    ...
    'Frisco, TX': { address: '3600 Dallas Pkwy, Frisco, TX 75034', lat: 33.0975, lon: -96.8335 },
    'Gainesville, GA': { address: '1900 Jesse Jewell Pkwy SE, Gainesville, GA 30501', lat: 34.2790, lon: -83.8055 },
    ...
    'Pittsburgh, PA': { address: '411 S 2nd St, Pittsburgh, PA 15219', lat: 40.4323, lon: -79.9928 },
    ...
    'Virginia Beach, VA': { address: '4532 Main St, Virginia Beach, VA 23462', lat: 36.8373, lon: -76.1265 },
};
