...
export const STORE_DETAILS: Record<string, StoreDetails> = {
    ...
    'Columbia, SC': { address: '2138 Pickens Street, Columbia, SC 29201', lat: 34.0151, lon: -81.0264 },
    ...
    'Omaha, NB': { address: '830 Harney St, Omaha, NE 68102', lat: 41.2543, lon: -95.9329 },
